        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{Auth::user()->Hovaten}}</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="{{ Request::is('settings') ? 'active' : '' }}"><a href="{{url('settings')}}" title="Settings" class="toggled waves-effect waves-block">
