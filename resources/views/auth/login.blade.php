                ...
                <form id="sign_up" method="POST" action="{{ route('login') }}" data-pjax>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line {{ $errors->has('username') ? ' error' : '' }}">
                            <input id="name" type="text" placeholder="@lang('Tên đăng nhập')" value=""
                    ...
                    <div class="input-group {{ $errors->has('password') ? ' error' : '' }}">
                        ...
                        <div class="form-line">
                            <input id="password" placeholder="@lang('Mật khẩu')" value="" type="password"
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <div class="col-xs-6 align-right font-bold">
                            <a class="font-b" href="{{ route('password.request') }}">@lang('auth.forget_password')</a>
                        </div>
                        @else
