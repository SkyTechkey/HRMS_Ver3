...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <form method="post" action="{{url('phanquyen/sua/'.$roles->id)}}">
        @csrf
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h2 class="card-inside-title">{{$roles->name}}</h2>
                            ...
                            <div class="demo-switch">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="demo-switch-title">{{$permissions->name}}</div>
                                        <div class="switch">
                                            <label><input name="permission[]" value ="{{$permissions->name}}" type="checkbox" @if($roles->permissions->contains($permissions->id)) checked=checked @endif><span class="lever switch-col-red"></span></label>
                                        </div>
                                    </div>
                                    @endforeach
