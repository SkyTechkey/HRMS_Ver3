                        ...
                        <div class="header">
                            <h2>
                                ...
                                <div style="float:right" >
                                    ...
                                    <a href="{{url('xuattinhoc')}}" class="btn btn-info btn-lg">Xuất Danh Sách</a>
                        ...
                        <div  class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                    @foreach($tin_hoc as $item)
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td>{{$item->word}}</td>
                                            <td>{{$item->excel}}</td>
                                            <td>{{$item->power_point}}</td>
                                            <td>
                                                <a href="{{url('xoatinhoc/'.$item->id)}}"  class="button delete-confirm"><i style="font-size:22px" class="material-icons">delete_forever</i></a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 style='color:#00b0e4' class="modal-title">Thêm Trình Độ Tin Học</h4>
                                    </div>
                                    <div  class="body">
                                        <form action = "{{url('themtinhoc')}}" id="form_validation" method="POST">
                                            @csrf
                            ...
                            <div class="modal fade" id="fix{{$item->id}}" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div  class="body">
                                            <form action = "{{url('suatinhoc/'.$item->id)}}" id="form_validation" method="POST">
                                                @csrf
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input  type="text" class="form-control" name="word" value ="{{$item->word}}"  required>
                                                    </div>
                                                    <div class="form-line">
                                                        <input  type="text" class="form-control" name="excel" value ="{{$item->excel}}"  required>
                                                    </div>
                                                    <div class="form-line">
                                                        <input  type="text" class="form-control" name="power_point" value ="{{$item->power_point}}"  required>
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-primary btn-block waves-effect" data-placement-from="top" data-placement-align="right"
                                                        data-animate-enter="" data-animate-exit="" data-color-name="bg-black">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="card bg-light mt-3">
                                        <div class="card-body">
                                            <form action="{{ url('nhaptinhoc') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
