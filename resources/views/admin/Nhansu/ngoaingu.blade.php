                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <h2>
                            ...
                            <div style="float:right; padding-right: 10px;" >
                                <a class="btn btn-info btn-lg button delete-all" href="{{url('/ngoaingu/xoaAll/')}}">Xóa tất cả</a>
                                   
                                </div>
                            <div style="float:right; padding-right: 10px;" >
                                <a class="btn btn-info btn-lg" href="{{ route('NgoainguExport') }}">Xuất danh sách</a>  
                            </div>
                            <div style="float:right; padding-right: 10px;" >
                        ...
                        <div class="modal fade" id="import" role="dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 style='color:#00b0e4' class="modal-title">Import Ngoại ngữ</h4>
                                </div>
                                <div  class="body">
                                    <form action="{{ route('NgoainguImport') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    @foreach($ngoaingus as $value)
                                    <tr>

                                        <td>{{$value->id}}</td>
                                        <td>{{$value->TenNN_Ngoaingu}}</td>
                                        
                                        <td>
                                        
                                        
                                        <a href="{{url('/ngoaingu/xoa/'.$value->id)}}"  class="button delete-confirm"><i style="font-size:22px" class="material-icons">delete_forever</i></a>
                                    ...
                                    <div class="modal fade" id="fix{{$value->id}}" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <h4 style='color:#00b0e4' class="modal-title">Sửa Ngoại ngữ {{$value->TenNN_Ngoaingu}}</h4>
                                            </div>
                                            <div  class="body">
                                                <form action = "{{url('ngoaingu/sua/'.$value->id)}}" id="form_validation" method="POST">
                                                @csrf
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input  type="text" class="form-control" name="TenNN_Ngoaingu" value ="{{$value->TenNN_Ngoaingu}}"  required>     
                                                        </div>
                    ...
                    <div class="modal fade" id="myModal" role="dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 style='color:#00b0e4' class="modal-title">Tạo Ngoại ngữ</h4>
                            </div>
                            <div  class="body">
                                <form action = "{{url('ngoaingu/them')}}" id="form_validation" method="POST">
                                @csrf
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input  type="text" class="form-control" name="TenNN_Ngoaingu" placeholder="Tên Ngoại ngữ"  required>
                                        </div>
