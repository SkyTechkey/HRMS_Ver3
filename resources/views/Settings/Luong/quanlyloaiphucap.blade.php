            ...
            <div class="header">
                <h2>
                    ...
                    <div style="float:right">
                        ...
                        @endcan
                        @can('Export.PhuCap')
                        <a href="{{route('quanlyloaiphucap.export')}}" class="btn btn-success waves-effect">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endcan
                                    @can('Delete.PhuCap')
                                    <a href="{{route('quanlyloaiphucap.delete',$value->id)}}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">CẬP NHẬP LOẠI PHỤ CẤP</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('quanlyloaiphucap.edit',$value->id) }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="Tenloaiphucap">Tên loại phụ cấp</label>
                        <div class="form-line">
                            <input type="text" value="{{$value->Ten_phucap}}" class="form-control" id="Tenloaiphucap"
                                name="name" placeholder="Tên loại phụ cấp" maxlength="255" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Sotien">Số tiền</label>
                        <div class="form-line">
                            <input type="text" value="{{$value->Sotien}}" class="form-control" id="sotien" name="sotien"
                                placeholder="Số tiền" maxlength="255" required />
                        </div>
                    </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI LOẠI PHỤ CẤP</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('quanlyloaiphucap.store') }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="Tenloaiphucap">Tên loại phụ cấp</label>
                        <div class="form-line">
                            <input type="text" class="form-control" id="Tenloaiphucap" name="name"
                                placeholder="Tên loại phụ cấp" maxlength="255" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Sotien">Số tiền</label>
                ...
                <div class="card-body">
                    <div class="body">
                        <p>- Tải file mẫu <a style="color: blue"
                                href="{{ asset('project_asset/template/templateImportLoaiPhuCap.xlsx')}}">Link</a>
                        </p>
                        <form action="{{ route('quanlyloaiphucap.import') }}" method="POST"
