            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php $i=1; ?>
                        <tbody>
                            @foreach($nghile as $item)
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td>{{$item->Ten_nghile}}</td>
                                <td>{{$item->Nam}}</td>
                                <td>{{\Carbon\Carbon::parse($item->Ngaynghi)->format('d/m/Y')}}</td>
                                <td>{{$item->Loai}}</td>
                                <td>{{$item->Heso}}</td>
                                <td>{{$item->Ghichu}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('nghile.destroy',$item->id)}}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">SỬA KÌ NGHỈ LỄ</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('nghile.edit', $item->id) }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="Tennghile">Tên nghỉ lễ</label>
                        <div class="form-line">
                            <input type="text" class="form-control" id="tennghile" name="tennghile"
                                value="{{$item->Ten_nghile}}" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" id="nam" name="nam"
                                value="{{$item->Nam}}" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="date" class="form-control" id="ngaynghi" name="ngaynghi"
                                value="{{$item->Ngaynghi}}" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" id="loai" name="loai"
                                    value="{{$item->Loai}}" maxlength="255" required />
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" id="heso" name="heso"
                                    value="{{$item->Heso}}" maxlength="255" required />
                            </div>
                    </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI KÌ NGHỈ LỄ</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('nghile.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" id="tennghile" name="tennghile"
                                placeholder="Tên nghỉ lễ" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" id="nam" name="nam"
                                placeholder="Năm" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="date" class="form-control" id="ngaynghi" name="ngaynghi"
                                placeholder="Ngày nghỉ" maxlength="255" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" id="loai" name="loai"
                                    placeholder="Loại" maxlength="255" required />
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" id="heso" name="heso"
                                    placeholder="Hệ số" maxlength="255" required />
                            </div>
                    </div>
