    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="header">
                ...
                <h2>
                    Danh Sách Quản Lý Vị Trí Tuyển Dụng
                    <div style="float:right">
                        ...
                        <a href="{{route('tuyendung.export')}}" class="btn btn-info btn-lg">Xuất
                            Danh
                            Sách</a>
                        @endcan
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('tuyendung.delete',$value->id)}}" class="button delete-confirm"><i
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI VỊ TRÍ TUYỂN DỤNG</h4>
            </div>
