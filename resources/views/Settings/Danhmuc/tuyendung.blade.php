            ...
            <div class="header">
                ...
                <h2>
                    ...
                    <div style="float:right">
                        ...
                        @endcan
                        @can('Export.TuyenDung')
                            <a href="{{route('tuyendung.export')}}" class="btn btn-success waves-effect">
                                <i class="material-icons">download</i>
                                Xuất file</a>
                        @endcan

                        @can('Create.TuyenDung')
                    ...
                    <table class="table table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{$value->id}}</td>
                                <td>{{$value->Ten_vitrituyendung}}</td>
                                <td>{{$value->Ghichu}}</td>
                                ...
                                <td>
                                    ...
                                    @can('Delete.TuyenDung')
                                        <a href="{{route('tuyendung.delete',$value->id)}}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">CẬP NHẬP VỊ TRÍ TUYỂN DỤNG</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('tuyendung.edit',$value->id) }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="Tenvitri">Tên vị trí</label>
                        <div class="form-line">
                            <input type="text" value="{{$value->Ten_vitrituyendung}}" class="form-control" id="Tenvitri"
                                name="name" placeholder="Tên vị trí" maxlength="255" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Tenphongban">Ghi chú</label>
                        <div class="form-line">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI TUYỂN DỤNG</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('tuyendung.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="Tenvitri">Tên vị trí</label>
                        <div class="form-line">
                            <input type="text" class="form-control" id="Tenvitri" name="name" placeholder="Tên vị trí"
                ...
                <div class="card-body">
                    <div class="body">
                        <p>- Tải file mẫu <a style="color: blue"
                                href="{{ asset('project_asset/template/templateImportDanhMucTuyenDung.xlsx')}}">Link</a>
                        </p>
                        <form action="{{ route('tuyendung.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
