            ...
            <div class="header">
                ...
                <h2>
                    ...
                    <div style="float:right">
                        ...
                        @endcan
                        @can('Export.ChucVu')
                            <a href="{{route('chucvu.export')}}" class="btn btn-success waves-effect">
                            ...
                            <tr>
                                ...
                                <td>
                                   @can('Edit.ChucVu')
                                    ...
                                    @can('Delete.ChucVu')
                                        <a href="{{route('chucvu.delete',$value->id)}}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">CẬP NHẬP CHỨC VỤ</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('chucvu.edit',$value->id) }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="Tenchucvu">Tên chức vụ</label>
                        <div class="form-line">
                            <input type="text" value="{{$value->Ten_chucvu}}" class="form-control" id="Tenchucvu"
                                name="name" placeholder="Tên chức vụ" maxlength="255" required />
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI CHỨC VỤ</h4>
            </div>
            <div class="modal-body">
                <form action="{{ route('chucvu.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="Tenchucvu">Tên chức vụ</label>
                        <div class="form-line">
                            <input type="text" class="form-control" id="Tenchucvu" name="name" placeholder="Tên chức vụ"
                ...
                <div class="card-body">
                    <div class="body">
                        <p>- Tải file mẫu <a style="color: blue"
                                href="{{ asset('project_asset/template/templateImportDanhMucChucVu.xlsx')}}">Link</a>
                        </p>
                        <form action="{{ route('chucvu.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
