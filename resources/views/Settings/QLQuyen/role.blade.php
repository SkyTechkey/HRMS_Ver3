                ...
                <div class="card">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="{{route('role.delete',$value->id)}}"  class="button delete-confirm"><i style="font-size:22px" class="material-icons">delete_forever</i></a>
                                    ...
                                    <div class="modal fade" id="fix{{$value->id}}" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div  class="body">
                                                <form action = "{{route('role.update',$value->id)}}" id="form_validation" method="POST">
                                                @csrf
                    ...
                    <div class="modal fade" id="myModal" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div  class="body">
                                <form action = "{{route('role.store')}}" id="form_validation" method="POST" >
                                @csrf
                                    <div class="form-group form-float">
                                        <div class="form-line">
