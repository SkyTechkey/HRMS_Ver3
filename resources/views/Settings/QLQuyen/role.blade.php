            ...
            <div class="header">
                ...
                <h2>
                    ...
                    <div style="float:right">
                        ...
                        @endcan
                        @can('Export.Role')
                        <a href="{{route('role.export')}}" class="btn btn-info btn-lg">Xuất
                            Danh
                            Sách</a>
                        @endcan
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('Delete.Role')
                                    <a href="{{route('role.delete',$value->id)}}" class="button delete-confirm"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('role.edit',$value->id) }}" method="post">
                    @csrf

                    <div class="form-group">
                        <label for="Tenngoaingu">Tên quyền</label>
                        <div class="form-line">
                            <input type="text" value="{{$value->name}}" class="form-control" id="Tenquyen" name="name"
                                placeholder="Tên quyền" maxlength="255" required />
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="{{ route('role.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" id="Tenquyen" name="name" placeholder="Tên quyền"
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI QUYỀN</h4>
            </div>
