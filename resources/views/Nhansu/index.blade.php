                        ...
                        <table class="table table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i++;?></td>
                                    <td>{{$item->id}}</td>
                                    <td><img src="{{ asset('project_asset/images/image_users/'.$item->Hinhanh) }}" height="150px" width="250px"></td>
                                    <td>{{$item->Hovaten}}</td>
                                    <td>{{$item->username}}</td>
                                    ...
                                    @if($item->Trangthai=='danglamviec')
                                        ...
                                        <td><span class="label bg-blue">Đang làm việc</span></td>

                                    @elseif($item->Trangthai=='tamdungviec')
                                        <td><span class="label bg-orange">Tạm ngừng việc</span></td>

                                    @else
                                        <td><span class="label bg-red">Hết làm việc</span></td>
