                        ...
                        <table class="table table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr style="vertical-align: middle;">
                                    ...
                                    <td style="width:80px"><img class="classimage_avatar" src="{{ asset('project_asset/images/image_users/'.$item->Hinhanh) }}" title="Huỳnh Tấn Phát  - Phòng Kỹ Thuật"></td>
                                    <td>
                                        ...
                                        <br/>
                                        <span class="ngaytao">
                                            <i class="fa fa-calendar" istooltip="" title="" dacaidat-hronline-tooltip="true" data-original-title="Ngày vào làm"></i>
                                            {{date('d/m/Y', strtotime($item->Ngayvaolam))}}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-building" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            {{$item->username}}
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-sitemap" istooltip="" title="" dacaidat-hronline-tooltip="true" data-original-title="Phòng Ban"></i> HRONLINE GROUP
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-address-book-o" aria-hidden="true" istooltip="" title="" dacaidat-hronline-tooltip="true" data-original-title="Chức Danh"></i> Giám Đốc Nhân Sự
                                        </span>
                                        <br/>
                                    ...
                                    <td>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-phone" istooltip="" title="" dacaidat-hronline-tooltip="true"></i>
                                            {{$item->Sodienthoai}}
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-envelope-o" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            {{$item->Email}}
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-barcode" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            {{$item->id}}
                                        </span>
                                    ...
                                    <td>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-bank" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            Ngân hàng TMCP Công Thương Việt Nam
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-credit-card-alt" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            100456586376
                                        </span>
                                    </td>
                                    <td>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-graduation-cap" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            Đại học
                                        </span>
                                        <br/>
                                        <span class="ngaytao" style="padding:0">
                                            <i class="fa fa-bookmark" istooltip="" title="" dacaidat-hronline-tooltip="true" ></i>
                                            Full time
                                        </span>
