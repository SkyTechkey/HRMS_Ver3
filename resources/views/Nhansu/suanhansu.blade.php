                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 style='color:#00b0e4' class="modal-title" id="defaultModalLabel">THÊM MỚI NHÂN SỰ</h4>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('update.nhansu',$nhansu->id) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="hovaten" name="hovaten" placeholder="Họ và tên"
                                                                    maxlength="255" value="{{$nhansu->Hovaten}}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="username" name="username" placeholder="Username"
                                                                    maxlength="255" value="{{$nhansu->username}}" />
                                                            </div>
                                                        </div>
                                                        {{-- <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="date" class="form-control" id="ngayvaolam" name="ngayvaolam" placeholder="Ngày vào làm"
                                                                    maxlength="255" value="{{$nhansu->Ngayvaolam}}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="number" class="form-control" id="sodienthoai" name="sodienthoai" placeholder="Số điện thoại"
                                                                    maxlength="255" value="{{$nhansu->Sodienthoai}}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="email" class="form-control" id="email" name="email" placeholder="Email"
                                                                    maxlength="255" value="{{$nhansu->Email}}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="ghichu" name="ghichu" placeholder="Ghi chú"
                                                                    maxlength="255" value="{{$nhansu->Ghichu}}" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{route('index.nhansu')}}" type="button" class="btn btn-link waves-effect" data-dismiss="modal">Đóng</a>
                                                </div>
                                                </form>
                                            </div>
                                </div>
